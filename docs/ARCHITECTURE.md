...
whole HLS playlist (a separate audio rendition is then muxed in by `media_server.remux`, and the 1 fps proxy is a Transcoder job), and following a live
...
and hands the candidates to Gemini 3.6 Flash to score for relevance.
