...
const STRINGS = {
  'en-GB': {
    ...
    'opener.clipsDesc': 'Go straight to output — the moments are found, cut, and shaped for each destination.',
    ...
    'opener.askClips': 'Cut the best moments into clips.',
    ...
    'ingest.clips': 'Clips',
    'ingest.makeClipsOn': 'Clip suggestions and copy are drafted alongside the moments.',
    'ingest.makeClipsOff': 'Analysis stops at the moments — no clip suggestions, no copy.',
    'ingest.ready': 'Ready',
    'ingest.readyClips': 'clips on',
  ...
  de: {
    ...
    'opener.clipsDesc': 'Direkt zum Ergebnis — die Szenen werden gefunden, geschnitten und für jedes Ziel aufbereitet.',
    ...
    'opener.askClips': 'Schneide die besten Szenen zu Clips.',
    ...
    'ingest.clips': 'Clips',
    'ingest.makeClipsOn': 'Clip-Vorschläge und Texte entstehen zusammen mit den Szenen.',
    'ingest.makeClipsOff': 'Die Analyse endet bei den Szenen — keine Clip-Vorschläge, keine Texte.',
    'ingest.ready': 'Bereit',
    'ingest.readyClips': 'Clips an',
  ...
  it: {
    ...
    'opener.clipsDesc': 'Vai dritto al risultato — i momenti vengono trovati, tagliati e adattati a ogni destinazione.',
    ...
    'opener.askClips': 'Taglia i momenti migliori in clip.',
    ...
    'ingest.clips': 'Clip',
    'ingest.makeClipsOn': 'I suggerimenti di clip e i testi nascono insieme ai momenti.',
    'ingest.makeClipsOff': "L'analisi si ferma ai momenti — nessun suggerimento di clip, nessun testo.",
    'ingest.ready': 'Pronto',
    'ingest.readyClips': 'clip attive',
  ...
  fr: {
    ...
    'opener.clipsDesc': 'Allez droit au résultat — les moments sont trouvés, coupés et mis en forme pour chaque destination.',
    ...
    'opener.askClips': 'Coupe les meilleurs moments en clips.',
    ...
    'ingest.clips': 'Clips',
    'ingest.makeClipsOn': 'Les suggestions de clips et les textes sont rédigés avec les moments.',
    'ingest.makeClipsOff': "L'analyse s'arrête aux moments — pas de suggestions de clips, pas de textes.",
    'ingest.ready': 'Prêt',
    'ingest.readyClips': 'clips activés',
  ...
  es: {
    ...
    'opener.clipsDesc': 'Ve directo al resultado — los momentos se encuentran, se cortan y se adaptan a cada destino.',
    ...
    'opener.askClips': 'Corta los mejores momentos en clips.',
    ...
    'ingest.clips': 'Clips',
    'ingest.makeClipsOn': 'Las sugerencias de clips y los textos se redactan junto a los momentos.',
    'ingest.makeClipsOff': 'El análisis termina en los momentos — sin sugerencias de clips ni textos.',
    'ingest.ready': 'Listo',
    'ingest.readyClips': 'clips activados',
